...
<div class="list-group bg-info hms-sidebar">
    ...
    <a href="prescription.php" class="list-group-item list-group-item-action <?php echo $currentPage === 'prescription.php' ? 'active' : ''; ?>"><i class="fas fa-file-prescription"></i>Prescriptions</a>
    <a href="invoice.php" class="list-group-item list-group-item-action <?php echo $currentPage === 'invoice.php' || $currentPage === 'view.php' || $currentPage === 'receipt.php' ? 'active' : ''; ?>"><i class="fas fa-file-invoice-dollar"></i>Bills</a>
</div>
